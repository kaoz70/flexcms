    ...
    <? foreach ($products as $producto): ?>
        <li class="producto">
            ...
            <? foreach($producto->precios as $precio):?>
                <? if($precio->contenido && $precio->contenido->productoCampoRelContenido != ''): ?>
                    <div class="precio">
                ...
                <? endif ?>
            <? endforeach; ?>
            <a class="ver_producto" href="<?=base_url()?><?=$diminutivo?>/<?=$paginaCatalogoUrl?>/<?=$producto->categoria->id?>/<?=$producto->categoria->productoCategoriaUrl?>/<?=$producto->productoUrl?>"><?=$this->lang->line('ui_view_product')?></a>
        </li>
    <? endforeach ?>
</ul>
<?=$pagination?>