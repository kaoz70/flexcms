<div class="content">
    ...
    <img style="position: absolute;" class="mapa_fondo" src="<?= base_url('assets/public/images/mapas/mapa_' . $mapa->mapaId . '.' . $mapa->mapaImagen) ?>" alt="<?=$mapa->mapaNombre?>" />
    <ul class="mapa_ubicaciones" style="position: absolute; width: 100%; height: 100%">
