...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'paginas/autenticacion/email/';
...
$config['message_start_delimiter'] = '<div class="mensaje">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="error">';		// Error mesage start delimiter
