...
return array(
    ...
    'Catalog' => $baseDir . '/framework/application/controllers/admin/catalog/Catalog.php',
    'CatalogTree' => $baseDir . '/framework/application/models/eloquent/CatalogTree.php',
    'Contact' => $baseDir . '/framework/application/controllers/admin/contact/Contact.php',
    ...
    'Day' => $baseDir . '/framework/application/controllers/admin/calendar/Day.php',
    ...
    'GalleryTree' => $baseDir . '/framework/application/models/eloquent/GalleryTree.php',
    ...
    'Map' => $baseDir . '/framework/application/controllers/admin/maps/Map.php',
    ...
    'Minify_CacheInterface' => $vendorDir . '/mrclay/minify/min/lib/Minify/CacheInterface.php',
    ...
    'Minify_Cache_Null' => $vendorDir . '/mrclay/minify/min/lib/Minify/Cache/Null.php',
    ...
    'Minify_ControllerInterface' => $vendorDir . '/mrclay/minify/min/lib/Minify/ControllerInterface.php',
    ...
    'Minify_Env' => $vendorDir . '/mrclay/minify/min/lib/Minify/Env.php',
    ...
    'Minify_LessCssSource' => $vendorDir . '/mrclay/minify/min/lib/Minify/LessCssSource.php',
    ...
    'Minify_ServeConfiguration' => $vendorDir . '/mrclay/minify/min/lib/Minify/ServeConfiguration.php',
    'Minify_Source' => $vendorDir . '/mrclay/minify/min/lib/Minify/Source.php',
    'Minify_SourceInterface' => $vendorDir . '/mrclay/minify/min/lib/Minify/SourceInterface.php',
    'Minify_SourceSet' => $vendorDir . '/mrclay/minify/min/lib/Minify/SourceSet.php',
    'Minify_Source_Factory' => $vendorDir . '/mrclay/minify/min/lib/Minify/Source/Factory.php',
    'Minify_Source_FactoryException' => $vendorDir . '/mrclay/minify/min/lib/Minify/Source/FactoryException.php',
    ...
    'Publication' => $baseDir . '/framework/application/controllers/admin/publications/Publication.php',
    'Service' => $baseDir . '/framework/application/controllers/admin/services/Service.php',
    'Slider' => $baseDir . '/framework/application/controllers/admin/sliders/Slider.php',
    'User' => $baseDir . '/framework/application/controllers/admin/users/User.php',
    ...
    'calendar\\Activity' => $baseDir . '/framework/application/controllers/admin/calendar/Activity.php',
    'calendar\\Field' => $baseDir . '/framework/application/controllers/admin/calendar/Field.php',
    'catalog\\Category' => $baseDir . '/framework/application/controllers/admin/catalog/Category.php',
    'catalog\\Config' => $baseDir . '/framework/application/controllers/admin/catalog/Config.php',
    'catalog\\Field' => $baseDir . '/framework/application/controllers/admin/catalog/Field.php',
    'catalog\\File' => $baseDir . '/framework/application/controllers/admin/catalog/File.php',
    'catalog\\PredefinedList' => $baseDir . '/framework/application/controllers/admin/catalog/PredefinedList.php',
    'catalog\\PredefinedListItem' => $baseDir . '/framework/application/controllers/admin/catalog/PredefinedListItem.php',
    'catalog\\Product' => $baseDir . '/framework/application/controllers/admin/catalog/Product.php',
    'catalog\\Youtube' => $baseDir . '/framework/application/controllers/admin/catalog/Youtube.php',
    'contact\\Address' => $baseDir . '/framework/application/controllers/admin/contact/Address.php',
    'contact\\Field' => $baseDir . '/framework/application/controllers/admin/contact/Field.php',
    'contact\\Person' => $baseDir . '/framework/application/controllers/admin/contact/Person.php',
    'gallery\\Category' => $baseDir . '/framework/application/controllers/admin/gallery/Category.php',
    'gallery\\File' => $baseDir . '/framework/application/controllers/admin/gallery/File.php',
    'gallery\\Youtube' => $baseDir . '/framework/application/controllers/admin/gallery/Youtube.php',
    ...
    'maps\\Field' => $baseDir . '/framework/application/controllers/admin/sliders/Field.php',
    'maps\\Location' => $baseDir . '/framework/application/controllers/admin/maps/Location.php',
    'parseCSV' => $vendorDir . '/parsecsv/php-parsecsv/parsecsv.lib.php',
    'publications\\Image' => $baseDir . '/framework/application/controllers/admin/publications/Image.php',
    'services\\Image' => $baseDir . '/framework/application/controllers/admin/services/Image.php',
    'sliders\\Field' => $baseDir . '/framework/application/controllers/admin/maps/Field.php',
    'sliders\\Image' => $baseDir . '/framework/application/controllers/admin/sliders/Image.php',
    'users\\Field' => $baseDir . '/framework/application/controllers/admin/users/Field.php',
);
