...
class CI_Flexi_cart_lite
{
	...
	{
		if ($this->CI->flexi_cart_lite_model->is_positive($location_type_id) && $this->shipping_location_data())
		{
			foreach($this->shipping_location_data() as $location)
			{
	...
	private function get_active_discounts($discount_type = FALSE, $target = FALSE, $format = TRUE, $internal_value = FALSE)
	{
		...
		else
		{
			...
			if($this->CI->flexi->cart_contents['settings']['discounts'][$discount_type]) {
	...
	{	
		...
		if($this->CI->flexi->cart_contents['settings']['discounts']['reward_vouchers']){
	...
	public function surcharge_data($surcharge_id = FALSE, $format = TRUE, $internal_value = FALSE)
	{
		...
		else
		{
			...
			if($this->CI->flexi->cart_contents['settings']['surcharges']) {
