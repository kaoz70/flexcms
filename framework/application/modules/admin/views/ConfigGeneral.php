    ...
    <md-content class="panel-body">
        ...
        <md-card>
            ...
            <md-card-content>
                ...
                <md-input-container class="md-block md-hue-1">
                    <input ng-model="config.site_name" type="text" placeholder="Nombre del Sitio" ng-required="true">
                </md-input-container>

                <div>
                    <md-input-container class="md-hue-1">
                        <label>P&aacute;gina inicial</label>
                        <md-select class="md-hue-1" ng-model="config.index_page_id">
                            <md-option ng-repeat="page in pages"
                                       ng-selected="page.id == config.index_page_id"
                                       ng-value="page.id">
                ...
                <div>
                    <md-input-container class="md-hue-1">
                        ...
                        <md-select class="md-hue-1" ng-model="config.theme">
                            <md-option ng-repeat="theme in themes"
                                       ng-selected="{{theme == config.theme}}"
                                       ng-value="theme">
                                {{theme}}
                            </md-option>
                        </md-select>
        ...
        <md-card>
            ...
            <md-card-content>
                ...
                <md-switch ng-model="config.debug_bar" aria-label="Barra depuradora">
                    Barra depuradora
                </md-switch>

                <md-switch ng-model="config.indent_html" aria-label="Indentar HTML">
                    Indentar HTML
                </md-switch>
