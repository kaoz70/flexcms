...
*/
	...
	*/
	...
	$config['email']['email_template'] = 'paginas/cart/email/order_email.tpl.php';
	...
	$config['messages']['delimiters']['status_prefix'] = '<div data-alert class="alert-box radius">';
	
	// Status Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '<a href="#" class="close">&times;</a></div>';
	
	// Error Message Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<div data-alert class="alert-box error radius">';
	
	// Error Message End Delimiter
	$config['messages']['delimiters']['error_suffix'] = '<a href="#" class="close">&times;</a></div>';
