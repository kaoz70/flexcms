...
?>
	...
	<div class="field">
		...
		<div class="content">
            ...
            <div class="input">
                <label for="paginaId">Pagina:</label>
                <select id="paginaId" name="paginaId">
                    <?php foreach($paginas as $pagina): ?>
                        <option <?= $pagina['paginaId'] == $paginaId ? 'selected="selected"' : ''?> value="<?= $pagina['paginaId'] ?>"><?= $pagina['paginaNombreMenu'] ?></option>
                    <?php  endforeach; ?>
                </select>
            </div>
...
<a href="<?= $link; ?>" data-level="nivel2" data-edit-url="publicidad/modificar/" data-delete-url="publicidad/eliminar/" class="guardar boton importante n1 no_sort <?=$nuevo?>" ><?=$txt_boton;?></a>
