...
<a href="<?= $link;?>" data-level="nivel2" data-edit-url="contact/edit_form_field/" data-delete-url="contact/delete_form_field/" class="guardar boton importante n1 contacto_form <?=$nuevo?>" ><?=$txt_boton;?></a>