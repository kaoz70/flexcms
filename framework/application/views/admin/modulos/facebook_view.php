<h3 id="tempMod_<?=$moduleId?>">Facebook</h3>
...
<p class="input small">
	<label for="parametro1">App ID:</label>
	<input id="parametro1" type="text" name="parametro1" value="<?=$moduleData->moduloParam1?>" />
</p>

<p class="input small">
	<label for="parametro2">Pagina URL:</label>
