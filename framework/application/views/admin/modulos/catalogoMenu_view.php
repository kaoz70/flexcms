<h3 id="tempMod_<?=$moduleId?>">Catalogo - Menu</h3>
...
<p class="input check">
	<input id="parametro1_<?=$moduleId?>" type="checkbox" name="parametro1" <?= $moduleData->moduloParam1 ? 'checked' : '' ?> />
	<label for="parametro1_<?=$moduleId?>">Mostrar productos</label>
</p>
<p class="input small">
