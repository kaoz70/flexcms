...
<a href="<?= $link; ?>" data-level="nivel4" data-edit-url="banners/modificarImagen/<?=$bannerId?>/<?=$imageId?>" data-delete-url="banners/eliminarImagen/<?=$bannerId?>/<?=$imageId?>" class="guardar boton importante n1 <?=$nuevo?>" ><?=$txt_boton;?></a>
