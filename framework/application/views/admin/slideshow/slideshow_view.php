...
<a class="nivel3 ajax boton_imagesBanner boton n2" href="<?=base_url('admin/slideshow/images/'.$bannerId)?>">Administrar Imágenes</a>
<a href="<?= $link; ?>" data-level="nivel2" data-edit-url="slideshow/edit/" data-delete-url="slideshow/delete/" class="guardar boton importante n1 no_sort <?=$nuevo?>" ><?=$txt_boton;?></a>