				...
				<div class="field">
					...
					<div class="content">
						...
						<div class="input">
							...
							<p class="input">Mapa: <a class="nivel3 pagina_nombre boton importante" href="<?=base_url('admin/mapas/cargarMapas/'.$mapaId)?>" id="<?=$mapaId;?>"><?=$mapaNombre;?></a></p>
...
<a href="<?= $link; ?>" data-level="nivel2" data-edit-url="mapas/modificarUbicacion/" data-delete-url="mapas/eliminarUbicacion/" class="guardar boton importante n1 no_sort <?=$nuevo?>" ><?=$txt_boton;?></a>
