...
(function(){
    ...
    this.Tree = new Class({
        ...
        onDrag: function(el, event){
            ...
            if (this.previous) this.previous.show();
            this.previous = null;
            ...
            if (this.drop.target) {
                this.drop.target.getParent().addClass(this.options.dropClass);
        ...
        removeDropClass: function(){
            var options = this.options;
            this.element.removeClass(options.dropClass);
            this.element.getElements('ul').each(function(item, index){
